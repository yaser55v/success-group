export default {
  ...
  colors: {
    ...
    primary: '#2563FF', // primary button and link color
  ...
  section: {
    keyFeature: {
      ...
      py: ['90px', null, 9, null, null, 10, null, '165px'],
    },
    feature: {
    ...
    services: {
      py: ['90px', null, 9, null, null, 10, null, '150px'],
    },
    pricing: {
  ...
  buttons: {
    ...
    primary: {
      ...
      bg: 'primary',
      '&:hover': {
        boxShadow: 'rgba(37, 99, 255, 0.57) 0px 9px 20px -5px',
      },
    },
    whiteButton: {
      variant: 'buttons.defaultBtn',
